            ...
            <form class="form-horizontal" name="changebank" method="post">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3 col-sm-12 text-center">
                        <form action="{{URL::to('admin/change-password')}}" method="POST" oninput='repassword.setCustomValidity(repassword.value != password.value ? "Xác nhận mật khẩu không đúng" : "")'>
                            {{ csrf_field() }}
