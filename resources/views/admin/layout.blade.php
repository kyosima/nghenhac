        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{URL::to('danh-sach')}}">Danh sách người dùng</a>
                        <a class="collapse-item" href="{{URL::to('them-nguoi-dung')}}">Thêm người dùng</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities1" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{URL::to('danh-sach-video')}}">Danh sách video</a>
                        <a class="collapse-item" href="utilities-border.html">Thêm video</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="utilities-color.html">Lệnh nạp</a>
                        <a class="collapse-item" href="utilities-border.html">Lệnh rút</a>
                        <a class="collapse-item" href="utilities-border.html">Thêm lệnh Nạp/Rút</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        padding-right: 25px;">
                            <i class="fa fa-money fa-fw"></i>
                                    <strong>Số dư :</strong> <span style="color: red;">1.000.000 <sup>vnđ</sup></span>
                        </div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{URL::to('/ho-so')}}">
